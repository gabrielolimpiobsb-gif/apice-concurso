...
const pack = {
  id: "detran-sp-01",
  title: "CTB - DETRAN SP",
  description: "Sistema Nacional de Trânsito, Normas Gerais, Infrações e Penalidades.",
  price: 29.90,
...
if (packsFile.includes('export const flashcardPacks: FlashcardPack[] = [')) {
    const insertStr = 'export const flashcardPacks: FlashcardPack[] = [\n  ' + JSON.stringify(pack, null, 2) + ',';
    packsFile = packsFile.replace('export const flashcardPacks: FlashcardPack[] = [', insertStr);
